...
migrateup1:
	migrate -path db/migration -database "postgresql://guy.ronen:secret@localhost:5432/simple_bank?sslmode=disable" -verbose up 1

migratedown1:
	migrate -path db/migration -database "postgresql://guy.ronen:secret@localhost:5432/simple_bank?sslmode=disable" -verbose down 1
